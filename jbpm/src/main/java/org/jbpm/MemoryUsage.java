...
import org.jbpm.thread.CompleteTasksThread;
import org.jbpm.thread.StartProcessInstancesThread;
import org.jbpm.thread.StatisticsSpitterThread;
...
public class MemoryUsage {
    ...
    public static void main(String[] args) {
        logger.info("Booting jbpm Process Engine ...");
        ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
        registerShutdownHook(processEngine);
        logger.info("Booting jbpm Process Engine DONE");
