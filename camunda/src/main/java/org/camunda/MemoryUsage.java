...
import org.camunda.thread.CompleteTasksThread;
import org.camunda.thread.StartProcessInstancesThread;
import org.camunda.thread.StatisticsSpitterThread;
...
public class MemoryUsage {
    ...
    public static void main(String[] args) {
        logger.info("Booting Camunda Process Engine ...");
        ProcessEngine processEngine = ProcessEngines.getDefaultProcessEngine();
        registerShutdownHook(processEngine);
        logger.info("Booting Camunda Process Engine DONE");
